...
light1.add(pointLight, 'intensity').min(0).max(20).step(0.01)

// Lights2
const pointLight2 = new THREE.PointLight(0xff0000, 2)
pointLight2.position.set(1.1,1.1,1.1)
...
// Lights3
const pointLight3 = new THREE.PointLight(0x0ff009f, 2)
pointLight3.position.set(0.3,0.3,0.3)
